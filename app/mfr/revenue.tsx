...
export default function ManufacturerRevenue() {
  ...
  // Revenue by product
  const revenueByProduct = batteries.map(battery => {
        ...
        <View style={styles.paymentCard}>
          <View style={styles.paymentRow}>
            <View style={styles.paymentInfo}>
              ...
              <Text style={styles.paymentLabel}>Paid (Delivered)</Text>
            </View>
          ...
          <View style={styles.paymentRow}>
            <View style={styles.paymentInfo}>
              ...
              <Text style={styles.paymentLabel}>Pending Approval</Text>
            </View>
          ...
          <View key={product.id} style={styles.productCard}>
            ...
            <View style={styles.productInfo}>
              ...
              <View style={styles.productStats}>
                ...
                <Text style={styles.productStat}>{product.quantity} units</Text>
              </View>
            </View>
